...
export interface IEcosystemContext {
    ...
    setFilter: <T extends keyof IEcosystemFilters>(key: T, value: IEcosystemFilters[T]) => void;
}
...
export const EcosystemFilters: React.FC<Props> = ({ children }) => {
    ...
    const setFilter = <T extends keyof IEcosystemFilters>(key: T, value: IEcosystemFilters[T]) => {
        switch (key) {
            case "category":
