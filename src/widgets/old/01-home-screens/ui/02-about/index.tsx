...
import { HomeScreensEnum, IHomeAbout } from "widgets/old/01-home-screens/lib/types";
...
const About: React.FC = () => {
    ...
    return (
        <section className={css.about} id={HomeScreensEnum.ABOUT}>
            <div className="container">
                <div className={css.wrapper}>
                    <picture>
                        <source srcSet="/img/home/about-gradient.webp" type="image/webp" />
                        <img
                            className={css.image}
                            width={640}
                            height={480}
